...
public class MyCardListAdapter extends RecyclerView.Adapter<CardListViewHolder>
{
    List<Card> cList;
    Context context;

    MyCardListAdapter(List<Card> cList, Context context)
    {
        this.cList = cList;
    ...
    public CardListViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                int position = MyCardListActivity.cardList.getChildLayoutPosition(v);

                Intent intent = new Intent(itemView.getContext(), MyCardInfoActivity.class);
