...
public class ShowCardListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.show_card_list_layout);

        cardList = findViewById(R.id.show_card_list_recycler);
        cardList.setLayoutManager(new LinearLayoutManager(ShowCardListActivity.this));
        ...
        ShowCardListAdapter showCardListAdapter = new ShowCardListAdapter(cList, ShowCardListActivity.this);
        cardList.setAdapter(showCardListAdapter);
